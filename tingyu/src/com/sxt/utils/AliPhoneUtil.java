...
public class AliPhoneUtil {
    private static Integer newCode;
    //获取四位随即验证码
     ...
     */
    //发送手机验证码
    public static SendSmsResponse sendSms(String phonenumber, Integer newCode) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("北京尚学堂");
        //必填:短信模板-可在短信控制台中找到，发送国际/港澳台消息时，请使用国际/港澳台短信模版
        request.setTemplateCode("SMS_200188218");
